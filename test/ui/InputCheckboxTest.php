...
class InputCheckboxTest extends PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		self::$driver->get('http://localhost:8080/#test/checkbox');
	...
	public function testCheckbox1() {
		...
		$result = self::$driver->findElement(WebDriverBy::id('test-result1'));
	...
	public function testCheckbox2() {
		...
		$result = self::$driver->findElement(WebDriverBy::id('test-result2'));
	...
	public function testCheckbox3() {
		...
		$result = self::$driver->findElement(WebDriverBy::id('test-result3'));
