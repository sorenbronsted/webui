...
class InputRadioTest extends PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		self::$driver->get('http://localhost:8080/#test/radio');
	...
	public function testRadio1() {
		...
		$this->assertEquals('1', self::$driver->findElement(WebDriverBy::id('test-result'))->getText());
	}

	public function testRadio2() {
		self::$driver->findElement(WebDriverBy::id('radio2'))->click();
		$this->assertEquals('2', self::$driver->findElement(WebDriverBy::id('test-result'))->getText());
	}

	public function testRadio3() {
		self::$driver->findElement(WebDriverBy::id('radio3'))->click();
		$this->assertEquals('3', self::$driver->findElement(WebDriverBy::id('test-result'))->getText());
	}
}
