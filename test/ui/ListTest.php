...
class ListTest extends PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		self::$driver->get('http://localhost:8080/#test/list');

		// Change view
		self::$driver->wait()->until(
			WebDriverExpectedCondition::presenceOfElementLocated(WebDriverBy::id('ListTest'))
		);
	}

	public function testDefault() {
		$this->assertContains('Struer', self::$driver->findElement(WebDriverBy::id('test-result'))->getText());
	}
}
